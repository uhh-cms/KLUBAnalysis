...
void ratioPU (uint begin = 0, uint max=300000000,string const &infileName = "../../inputFiles/UL17_backgrounds/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8__RunIISummer20UL17MiniAODv2-106X_mc2017_realistic_v9-v1.txt", string const &myFileName = "MyMCPileupHistogram_TTToSemiLeptonicUL17")
{
